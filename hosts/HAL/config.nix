...
in
{
  ...
  services = {
    ...
    mpd = {
      enable = true;
      musicDirectory = "/home/l0cks/Music";
...
systemd.user.services.mpd-mpris = {
  ...
  # Enable sound with pipewire AND fix mpd
  hardware.pulseaudio.enable = false;
  services.mpd.user = "l0cks";
  systemd.services.mpd.environment = {
    # https://gitlab.freedesktop.org/pipewire/pipewire/-/issues/609
    XDG_RUNTIME_DIR = "/run/user/${toString config.users.users.l0cks.uid}"; # User-id must match above user. MPD will look inside this directory for the PipeWire socket.
